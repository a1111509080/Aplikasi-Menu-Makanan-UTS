...
public class SettingHarga extends AppCompatActivity {
    ...
    public static final String makan1 = "5000";
    public static final String makan2 = "3000";
    public static final String makan3 = "2000";
    public static final String makan4 = "500";
    public static final String makan5 = "13000";
    public static final String makan6 = "5000";
    public static final String makan7 = "2000";
